...
public class HomeworkM11PartTwo {
    ...
    public static void main(String[] args) {
        ...
        int numberChemicalsInAllProducts = productList
                .stream()
        ...
        long numberProductsFourOrMore = productList
                .stream()
                .filter(product -> product.getNumberOfChemicals() > 3)
                .count();
        ...
        Map<String, List<Product>> companyProductMap = productList
                .stream()
//                .collect(Collectors.toMap(Product::getCompany, Product::getChemicals));
                .collect(Collectors.groupingBy(product -> product.getCompany()));
    ...
    private static List<Product> createList() {
        String line = "";
        String fileName = "resources/ChemicalData.csv";
//        String fileName = "resources/sample.csv";
